class AlazanModel {
  ...
  AlazanModel({this.code, this.status, this.data});
...
class Hijri {
  ...
  List<dynamic>? holidays;  // Use dynamic or Object if it's just null
  ...
  Hijri.fromJson(Map<String, dynamic> json) {
    ...
    if (json['holidays'] != null) {
      holidays = List<dynamic>.from(json['holidays']);  // Just assign as a List of dynamic objects
    }
  }
